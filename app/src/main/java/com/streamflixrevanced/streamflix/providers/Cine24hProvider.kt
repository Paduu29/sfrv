...
object Cine24hProvider : Provider {
    ...
    override suspend fun getMovieFromProvider(id: String): Movie = getDocument("$baseUrl/peliculas/$id").let { doc ->
    ...
    override suspend fun getTvShowFromProvider(id: String): TvShow = getDocument("$baseUrl/series/$id").let { doc ->
        val info = doc.selectFirst(".TPost footer .Info, .Info")
    ...
    override suspend fun getEpisodesByProvider(seasonId: String): List<Episode> = try {
