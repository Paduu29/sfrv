...
object SerialeROProvider : Provider {
        ...
        companion object {
            fun build(baseUrl: String): SerialeROService {
                val client = OkHttpClient.Builder()
                    .dns(DnsResolver.doh)
                    .cookieJar(com.streamflixrevanced.streamflix.utils.NetworkClient.cookieJar)
    ...
    override suspend fun getGenre(id: String, page: Int): Genre {
        ...
        return Genre(
            id = id,
            name = name,
            shows = parseCards(document).map { it as com.streamflixrevanced.streamflix.models.Show }
        )
    }
    ...
    private fun parseRecommendations(document: Document, movie: Boolean): List<com.streamflixrevanced.streamflix.models.Show> {
