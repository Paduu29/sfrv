...
object TvporinternetHDProvider : IptvProvider {
    ...
    override suspend fun getMovieFromProvider(id: String): Movie = throw Exception("Not supported")

    override suspend fun getTvShowFromProvider(id: String): TvShow = if (id == "creador-info" || id == "apoyo-info") getInfoItem(id) else try {
    ...
    override suspend fun getEpisodesByProvider(seasonId: String): List<Episode> = listOf(Episode(seasonId, 1, "Señal en Directo"))
