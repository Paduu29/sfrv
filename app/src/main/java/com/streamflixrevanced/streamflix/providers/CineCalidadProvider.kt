...
object CineCalidadProvider : Provider {
    ...
    private const val TAG = "CineCalidadProvider"

    override val name = "CineCalidad"
    override val baseUrl = "https://www.cinecalidad.am"
    override val language = "es"
    override val logo = "$baseUrl/wp-content/themes/Cinecalidad/assets/img/logo.png"
    ...
    private val retrofit = Retrofit.Builder()
        ...
        // CineCalidad rejects OkHttp's default user agent with HTTP 403.
    ...
    override suspend fun getHome(): List<Category> {
        return try {
            ...
            Log.e(TAG, "Could not load home", e)
            emptyList()
        }
    }
    ...
    override suspend fun search(query: String, page: Int): List<AppAdapter.Item> {
        ...
        return try {
            ...
            Log.e(TAG, "Could not search page $page", e)
            emptyList()
        }
    }
    ...
    override suspend fun getMovies(page: Int): List<Movie> {
        return try {
            ...
            Log.e(TAG, "Could not load movies page $page", e)
            emptyList()
        }
    }
    ...
    override suspend fun getTvShows(page: Int): List<TvShow> {
        return try {
            ...
            Log.e(TAG, "Could not load TV shows page $page", e)
            emptyList()
        }
    }
    ...
    override suspend fun getServers(id: String, videoType: Video.Type): List<Video.Server> {
        return try {
            ...
            Log.e(TAG, "Could not load servers", e)
            emptyList()
        }
    }
    ...
    override suspend fun getGenre(id: String, page: Int): Genre {
        return try {
            ...
            Log.e(TAG, "Could not load genre $id page $page", e)
    ...
    override suspend fun getPeople(id: String, page: Int): People {
        ...
        return try {
            ...
            Log.e(TAG, "Could not load person $id page $page", e)
