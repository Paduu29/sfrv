...
data class RemoteMediaState(
    ...
    @EncodeDefault @SerialName("last_played_at_millis") val lastPlayedAtMillis: Long? = null,
    @EncodeDefault @SerialName("last_played_episode_id")
    ...
    companion object {
        ...
        fun fromTvShow(userId: String, provider: String, show: TvShow, now: Long) =
            RemoteMediaState(
                ...
                lastPlayedAtMillis = show.lastPlayedAtMillis,
                lastPlayedEpisodeId = show.lastPlayedEpisodeId,
                clientUpdatedAtMillis = now,
            )
        ...
        fun fromProviderFavorite(
            ...
            mediaType = "provider_favorite",
            mediaId = providerName,
            title = providerName,
            isFavorite = isFavorite,
            favoritedAtMillis = now.takeIf { isFavorite },
            clientUpdatedAtMillis = now,
        )
    }
}
