...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // Keep old profile databases alive while their ViewModels finish
        // cancelling. Closing a Room instance during a profile switch can
        // make an in-flight Flow/query crash with "connection pool closed".
        ...
        private val MIGRATION_9_10: Migration = object : Migration(9, 10) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "CREATE INDEX IF NOT EXISTS `index_episodes_tvShow_lastPlaybackPositionMillis` " +
                        "ON `episodes` (`tvShow`, `lastPlaybackPositionMillis`)"
                )
            }
        }
        ...
        private val MIGRATION_11_12: Migration = object : Migration(11, 12) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE movies ADD COLUMN imdbId TEXT")
            }
        }
    }
}
