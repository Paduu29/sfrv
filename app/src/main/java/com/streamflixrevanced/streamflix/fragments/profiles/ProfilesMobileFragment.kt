...
import com.streamflixrevanced.streamflix.databinding.FragmentProfilesMobileBinding
...
class ProfilesMobileFragment : Fragment() {
        ...
        AlertDialog.Builder(requireContext())
            ...
            .setItems(items.toTypedArray()) { _, which ->
                when (items[which]) {
                    ...
                    getString(R.string.profile_action_avatar) -> showAvatarDialog(profile)
    ...
    private fun showAvatarDialog(profile: Profile) {
