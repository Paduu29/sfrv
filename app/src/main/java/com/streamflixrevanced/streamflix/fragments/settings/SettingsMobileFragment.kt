...
class SettingsMobileFragment : PreferenceFragmentCompat() {
    ...
    private fun displaySettings() {
        ...
        findPreference<Preference>("key_profile_edit")?.setOnPreferenceClickListener {
            ...
            if (active != null) showProfileActionsDialog(active)
            true
        }
    ...
    private fun showProfileActionsDialog(profile: Profile, profileCount: Int = 1) {
        ...
        AlertDialog.Builder(requireContext())
            ...
            .setItems(items.toTypedArray()) { _, which ->
                when (items[which]) {
                    ...
                    getString(R.string.profile_action_avatar) -> showProfileAvatarDialog(profile)
    ...
    private fun showProfileAvatarDialog(profile: Profile) {
