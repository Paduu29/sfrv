package com.streamflixrevanced.streamflix.fragments.profiles
...
import com.streamflixrevanced.streamflix.adapters.ProfileAdapter
import com.streamflixrevanced.streamflix.databinding.FragmentProfilesTvBinding
...
class ProfilesTvFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        profileAdapter = ProfileAdapter(
            ...
            onProfileLongClick = { profile ->
                showProfileActionsTv(profile, profileAdapter.currentList.size)
            },
        ...
        androidx.appcompat.app.AlertDialog.Builder(requireContext())
            ...
            .setItems(items.toTypedArray()) { _, which ->
                when (items[which]) {
                    ...
                    getString(R.string.profile_action_avatar) -> showAvatarDialogTv(profile)
    ...
    private fun showAvatarDialogTv(profile: Profile) {
