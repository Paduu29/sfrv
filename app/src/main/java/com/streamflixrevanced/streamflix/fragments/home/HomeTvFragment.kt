...
class HomeTvFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            // Bind collection to the view lifecycle. The Fragment can remain
            // on the back stack when Profiles opens, so using the Fragment
            // lifecycle lets a late Home result touch a destroyed binding.
        ...
        categories
            ...
            ?.also {
                ...
                val poster = when (firstItem) {
                    ...
                    is LiveChannel -> firstItem.banner
                    else -> null
                }
            ...
            ?.also {
                ...
                it.list.forEach { show ->
                    when (show) {
                        ...
                        is TvShow -> show.itemType = AppAdapter.Type.TV_SHOW_CONTINUE_WATCHING_TV_ITEM
                        is LiveChannel -> show.itemType = AppAdapter.Type.LIVE_CHANNEL_TV_ITEM
                    }
                }
            }
                ...
                val position = appAdapter.items
                    ...
                    ?.let { category ->
                        ...
                        val poster = when (currentItem) {
                            ...
                            is LiveChannel -> currentItem.banner
                            else -> null
                        }
