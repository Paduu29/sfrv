...
class EpisodeViewHolder(
    ...
    private fun displayMobileItem(binding: ItemEpisodeMobileBinding) {
                    ...
                    SeasonMobileFragmentDirections.actionSeasonToPlayer(
                        ...
                        videoType = Video.Type.Episode(
                            ...
                            tvShow = Video.Type.Episode.TvShow(
                                ...
                                currentProgram = episode.tvShow?.currentProgram,
                            ),
                            season = Video.Type.Episode.Season(
                                number = episode.season?.number ?: 0,
                                title = episode.season?.title,
                            ),
                            resumePositionMillis = episode.watchHistory?.lastPlaybackPositionMillis,
                        ),
                    )
                )
            }
        ...
        binding.ivEpisodePoster.apply {
            clipToOutline = true
            Glide.with(context)
                .load(episode.poster ?: R.drawable.glide_fallback_cover)
    ...
    private fun displayContinueWatchingTvItem(binding: ItemEpisodeContinueWatchingTvBinding) {
        ...
        binding.ivEpisodeTvShowPoster.apply {
            clipToOutline = true
            loadContinueWatchingArtwork(withFallback = true, roundTop = true)
        }
    ...
    private fun ImageView.loadContinueWatchingArtwork(
        ...
        if (tvShow == null) {
            Glide.with(context)
                ...
                .apply {
                    ...
                    if (roundTop) topRoundedPoster(context)
                }
                .apply {
                    if (!roundTop) centerCrop()
                }
                .transition(DrawableTransitionOptions.withCrossFade())
                .into(this)
            return
